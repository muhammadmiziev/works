    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <p>Awesome!</p>
                <a href="/feedback" class="btn btn-primary btn-xl page-scroll">Отзывы</a>
                <h1>
                <?if(CheckUser::isAccess()) {?>
                    <a style="margin-top: 5px;" href="/adminpanel#no_accept_reviews" class="btn btn-primary btn-xl page-scroll">Перейти в админ панель</a>
                <?}?>
            </div>
        </div>
    </header>
